...
s​​imple_phylogeny-* outputs are retained as computational artifacts where
...
data/	Raw, processed, and database-level biological data
notebooks/	Interactive computational analyses
scripts/	Reusable analysis code
Results/	Derived computational outputs
figures/	Research visualizations
docs/	Methodology, provenance, reproducibility and interpretation
EleProtect_App/	Research-oriented computational application
♻️ 9. Reproducibility
...
The principal candidate datasets for quantitative reporting include:
...
A future consolidated quantitative summary can follow the structure:

Analysis	Metric	Result	Output
Sequence comparison	Sequence identity	Derived from analysis	ML/
Hotspot mapping	Corresponding residues	Derived from analysis	TP53_hotspot_analysis.csv
Feature analysis	Feature relationships	Derived from analysis	tp53_features_with_similarity.csv
Clustering	Sequence/feature groups	Derived from analysis	tp53_features_with_similarity_clustered.csv
Phylogeny	Tree topology	Derived from analysis	phylogeny/

Important: Values should be added to this table only after they have
been verified directly from the corresponding computational outputs.
